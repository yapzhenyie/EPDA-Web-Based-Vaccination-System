<%-- 
    ...
    Created on : Oct 15, 2021, 3:34:42 PM
    Author     : Yap Zhen Yie
--%>
...
<html>
    <head>
        ...
        <title>View Appointment | Appointment | EPDA Vaccination System</title>
            ...
            <div class="main-content">
                ...
                <div class="content">
                    <div class="header d-flex justify-content-between align-items-center mb-4 row">
                        <h2 class="font-weight-bold col-12">View Appointment</h2>
                    </div>
                    <div>
                        <div>
                            ...
                            <table class="table-striped" id="table" 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="vaccinatorDateOfBirth" rowspan="2" data-valign="middle" data-sortable="true" data-visible="false">Date of Birth</th>
