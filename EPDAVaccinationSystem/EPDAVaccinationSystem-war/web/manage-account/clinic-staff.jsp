<%-- 
    ...
    Created on : Oct 9, 2021, 4:47:57 PM
    Author     : Yap Zhen Yie
--%>
...
<html>
    <head>
        ...
        <title>Clinic Staff | Manage Account | EPDA Vaccination System</title>
            ...
            <div class="main-content">
                ...
                <div class="content">
                    <div class="header d-flex justify-content-between align-items-center mb-4 row">
                        <h2 class="font-weight-bold col-12">Clinic Staff</h2>
                    </div>
                    <div class="container-fluid mb-3">
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-4 v-card color-3">
    ...
    <script>
        ...
        window.operateAction = {
            'click .view': function (e, value, row, index) {
                loadViewUserDetailsModal(row.accountId, "<%= UserRole.Clinic_Staff.toString()%>");
            },
            'click .edit': function (e, value, row, index) {
                loadEditUserDetailsModal(row.accountId, "<%= UserRole.Clinic_Staff.toString()%>", "<%= ConstantLink.UrlManageAccountClinicStaff%>");
            },
            'click .lock': function (e, value, row, index) {
                showLockUnlockAccountModal(true, row.accountId, "<%= ConstantLink.UrlManageAccountClinicStaff%>");
            },
            'click .unlock': function (e, value, row, index) {
                showLockUnlockAccountModal(false, row.accountId, "<%= ConstantLink.UrlManageAccountClinicStaff%>");
            },
            'click .reset': function (e, value, row, index) {
                showResetPasswordModal(row.accountId, "<%= ConstantLink.UrlManageAccountClinicStaff%>");
            },
            'click .delete': function (e, value, row, index) {
                showDeleteAccountModal(row.accountId, "<%= ConstantLink.UrlManageAccountClinicStaff%>");
            }
        };
    </script>
    <script>
