 ...
 * @author Yap Zhen Yie
 */
@WebServlet(name = "LockUserAccount", urlPatterns = {"/LockUserAccount"})
public class LockUserAccount extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String emailAddress = request.getParameter("lockEmailAddress");
        String redirectUrl = request.getParameter("lockRedirectUrl");
        ...
        if (session.getAttribute(ConstantSession.UserCredentialRole) != null
            ...
            if (account != null) {
                ...
                session.setAttribute(ConstantSession.SuccessMessage, ConstantMessage.SuccessfulLockAccount);
                response.sendRedirect(redirectUrl);
            } else {
                session.setAttribute(ConstantSession.Validate, ConstantMessage.Error);
                session.setAttribute(ConstantSession.ValidateMessage, ConstantMessage.UnexpectedErrorOccurred);
