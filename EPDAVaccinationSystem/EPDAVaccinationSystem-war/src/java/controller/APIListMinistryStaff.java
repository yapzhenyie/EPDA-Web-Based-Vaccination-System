 ...
 * @author Yap Zhen Yie
 */
@WebServlet(name = "APIListMinistryStaff", urlPatterns = {"/APIListMinistryStaff"})
public class APIListMinistryStaff extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute(ConstantSession.UserCredentialRole) != null
            ...
            List<MinistryStaff> results = ministryStaffFacade.findAll();
            try {
