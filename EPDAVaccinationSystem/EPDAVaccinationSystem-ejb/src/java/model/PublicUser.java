...
public class PublicUser implements Serializable {
    ...
    public PublicUser(String name, String nricNo, int gender, Date dateOfBirth, String contactNo, String addressStreet, String addressCity, String addressState, String addressPostcode, String addressCountry, UserAccount account) {
        this.name = name;
        this.nricNo = nricNo;
        this.gender = gender;
    ...
    public String toString() {
        return "model.PublicUser[ id=" + id + ", name=" + name + " ]";
    }
